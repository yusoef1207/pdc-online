...
var User = {
    ...
    getById: function(id, callback) {  
        return db.query("Select ta.*, tap.applicant_program_id from tapplicant ta left join tapplicantprogram tap on tap.applicant_id = ta.applicant_id where ta.applicant_id=?", [id], callback);  
    },
